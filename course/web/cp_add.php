...
<form action="implement_cp_add.php" method="POST" class="am-form" enctype="multipart/form-data">
    <fieldset>
        <legend>商品添加</legend>

        <div class="am-form-group">
            <label for="doc-ipt-email-1">商品标题</label>
            <input type="text" name="goods_title" class="" id="doc-ipt-email-1" placeholder="输入商品标题">
        </div>

        <div class="am-form-group">
            <label for="doc-ipt-email-1">商品链接</label>
            <input type="text" name="goods_link" class="" id="doc-ipt-email-1" placeholder="输入商品链接">
        </div>

        <div class="am-form-group">
            <label for="doc-ipt-email-1">商品价格</label>
            <input type="text" name="goods_price" class="" id="doc-ipt-email-1" placeholder="输入商品价格">
        </div>
